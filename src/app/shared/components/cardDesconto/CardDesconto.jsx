...
export function CardDesconto({item}){

//usando reject
const result = item.thumbnail.replace(/\w\.jpg/gi, "W.jpg")

const { cartItemProduct , setCartItem} = useContext(AppContext)


//adiciona ao array do cart
const handleAddCart = () => setCartItem([ ...cartItemProduct, item])
    ...
    return(
        ...
        <div className="card-body">
            ...
            {/* formatando o price que chegou */}
            <h5 className="card-preco">{Util.FormatarMoeda(item.price)}</h5>
